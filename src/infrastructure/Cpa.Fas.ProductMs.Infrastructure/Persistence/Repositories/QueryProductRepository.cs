...
namespace Cpa.Fas.ProductMs.Infrastructure.Persistence.Repositories
{
    public class QueryProductRepository : IQueryProductRepository
    {
        ...
        public async Task<GetProductByIdQueryResponse?> GetByIdAsync(ProductId id)
        {
            ...
            return new GetProductByIdQueryResponse(ProductId.FromGuid(productModel.Id), productModel.Name, productModel.Price, productModel.Stock, productModel.IsDeleted);
        }
    }
}